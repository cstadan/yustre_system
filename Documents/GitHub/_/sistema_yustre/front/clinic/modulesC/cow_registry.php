...
<body class="clinic-module">
    ...
    <div class="main-content" id="mainContent">
        <div class="welcome-section">
            <h2 class="welcome-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="26" height="26"
                    fill="none" style="vertical-align:middle;margin-right:8px">
                    <path d="M6 8c0 0-1 12 6 12s6-12 6-12" stroke="#28a745" stroke-width="1.8" stroke-linecap="round" />
                    <path d="M6 8c1-3 11-3 12 0" stroke="#28a745" stroke-width="1.8" stroke-linecap="round" />
                    <path d="M6 8L4 5M18 8l2-3" stroke="#28a745" stroke-width="1.8" stroke-linecap="round" />
                    <path d="M9 16h6" stroke="#28a745" stroke-width="1.8" stroke-linecap="round" />
                </svg> Cow Registry</h2>
        ...
        <div class="filters-section">
            <form method="GET" action="cow_registry.php">
                <div class="row g-3">
                    <div class="col-md-4">
                        <label class="filter-label"><svg class="label-icon" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" width="14" height="14" fill="none">
                                <circle cx="11" cy="11" r="7" stroke="currentColor" stroke-width="1.8" />
                                <path d="M16.5 16.5L21 21" stroke="currentColor" stroke-width="1.8"
                                    stroke-linecap="round" />
                            </svg> Search by ID, Corral or Age</label>
                    ...
                    <div class="col-md-2">
                        <label class="filter-label"><svg class="label-icon" xmlns="http://www.w3.org/2000/svg"
                                ...
                                <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor"
                                    stroke-width="1.8" />
                                <path d="M3 9h18M9 9v12" stroke="currentColor" stroke-width="1.8"
                                    stroke-linecap="round" />
                            </svg> Filter by Corral</label>
                        <select name="corral" class="filter-select">
                            <option value="">All corrals</option>
                            <?php foreach ($corrals as $corral): ?>
                                <option value="<?php echo htmlspecialchars($corral); ?>" <?php echo $filter_corral == $corral ? 'selected' : ''; ?>>Corral
                                    <?php echo htmlspecialchars($corral); ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                    <div class="col-md-2">
                        ...
                        <select name="status" class="filter-select">
                            ...
                            <option value="Pregnant" <?php echo $filter_status == 'Pregnant' ? 'selected' : ''; ?>>Pregnant
                            </option>
                    ...
                    <div class="col-md-2">
                        <label class="filter-label"><svg class="label-icon" xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" width="14" height="14" fill="none">
                                <path d="M4 6h16M4 12h10M4 18h6" stroke="currentColor" stroke-width="1.8"
                                    stroke-linecap="round" />
                            </svg> Order by</label>
                        <select name="order" class="filter-select">
                            ...
                            <option value="age_desc" <?php echo $order_by == 'age_desc' ? 'selected' : ''; ?>>Age (Oldest
                                first)</option>
                            <option value="age_asc" <?php echo $order_by == 'age_asc' ? 'selected' : ''; ?>>Age (Youngest
                                first)</option>
                        </select>
                    </div>
        ...
        <div class="table-container">
            <div class="table-header">
                <h3 class="table-title">Cow List <span class="total-badge"><?php echo count($cows); ?> records</span>
                </h3>
                <button class="btn-add" data-bs-toggle="modal" data-bs-target="#addCowModal"><svg
                        ...
                        <tbody>
                            <?php foreach ($cows as $cow): ?>
                                <tr style="cursor:pointer;"
                                    onclick="openEditModal('<?php echo htmlspecialchars($cow['id']); ?>','<?php echo htmlspecialchars($cow['corral']); ?>','<?php echo htmlspecialchars($cow['status']); ?>','<?php echo htmlspecialchars($cow['age']); ?>','<?php echo htmlspecialchars(addslashes($cow['comments'])); ?>')">
                                    <td><strong><?php echo htmlspecialchars($cow['id']); ?></strong></td>
                                    <td>Corral <?php echo htmlspecialchars($cow['corral']); ?></td>
                                    <td><?php $s = strtolower($cow['status']);
                                    $c = 'status-active';
                                    if ($s == 'sick')
                                        $c = 'status-sick';
                                    elseif ($s == 'pregnant')
                                    ...
                                    elseif ($s == 'sold')
                                        $c = 'status-sold'; ?><span
                                            class="status-badge <?php echo $c; ?>"><?php echo htmlspecialchars($cow['status']); ?></span>
                                    </td>
            ...
            <?php else: ?>
                <div class="no-data">
                    <div style="display:flex;justify-content:center;margin-bottom:10px;opacity:.5;color:var(--text-muted)">
                        ...
                        </svg></div>No cows found matching the search criteria
                </div>
            <?php endif; ?>
        </div>
    </div>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15"
                            height="15" fill="none">
                            <path d="M12 5v14M5 12h14" stroke="currentColor" stroke-width="2" stroke-linecap="round" />
                        </svg> Add New Cow</h5><button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                </div>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        ...
                                        <path d="M3 9h18M9 9v12" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg> Corral <span class="text-danger">*</span></label><input type="text"
                                    name="corral" class="modal-input" placeholder="e.g. A1" required></div>
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        <circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.8" />
                                        <path d="M12 8v4l3 3" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg> Status <span class="text-danger">*</span></label><select name="status"
                            ...
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        ...
                                        <path d="M16 2v4M8 2v4M3 10h18" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg> Age (years) <span class="text-danger">*</span></label><input type="number"
                                    name="age" class="modal-input" placeholder="e.g. 3" min="0" max="30" required></div>
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        <rect x="2" y="5" width="20" height="14" rx="2" stroke="currentColor"
                                            stroke-width="1.8" />
                                        <path d="M8 10h8M8 14h5" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg> ID</label><input type="text" class="modal-input" value="Auto-generated"
                                    disabled style="opacity:.5"></div>
                            <div class="col-12"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        <path d="M8 9h8M8 13h5" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                        <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor"
                                            stroke-width="1.8" />
                                    </svg> Comments</label><textarea name="comments" class="modal-input" rows="3"
                ...
                <div class="modal-header">
                    <h5 class="modal-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15"
                            ...
                            <path d="M18.5 2.5a2.121 2.121 0 013 3L12 15l-4 1 1-4 9.5-9.5z" stroke="currentColor"
                                stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" />
                        </svg> Edit Cow &mdash; <span id="editModalTitle"></span></h5><button type="button"
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                    ...
                                    name="corral" id="edit_corral" class="modal-input" required></div>
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        <circle cx="12" cy="12" r="9" stroke="currentColor" stroke-width="1.8" />
                                    ...
                                    id="edit_status" class="modal-input" required>
                                    <option value="Active">Active</option>
                                    <option value="Sick">Sick</option>
                                    <option value="Pregnant">Pregnant</option>
                                    <option value="Sold">Sold</option>
                            ...
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                    ...
                                    name="age" id="edit_age" class="modal-input" min="0" max="30" required></div>
                            <div class="col-md-6"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        <rect x="2" y="5" width="20" height="14" rx="2" stroke="currentColor"
                                        ...
                                        <path d="M8 10h8M8 14h5" stroke="currentColor" stroke-width="1.8"
                                            stroke-linecap="round" />
                                    </svg> ID</label><input type="text" id="edit_id_display" class="modal-input"
                                    disabled style="opacity:.5"></div>
                            <div class="col-12"><label class="modal-label"><svg class="label-icon"
                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                                        fill="none">
                                        ...
                                        <rect x="3" y="3" width="18" height="18" rx="2" stroke="currentColor"
                                            stroke-width="1.8" />
                                    </svg> Comments</label><textarea name="comments" id="edit_comments"
                                    class="modal-input" rows="3"></textarea></div>
                        </div>
                    </div>
                    <div class="modal-footer d-flex justify-content-between">
                        <button type="button" class="btn btn-danger" onclick="deleteCow()"><svg
    ...
    <form method="POST" action="cow_registry.php" id="deleteForm"><input type="hidden" name="action"
            value="delete_cow"><input type="hidden" name="csrf_token" value="<?php echo $csrf_token; ?>"><input
            type="hidden" name="delete_id" id="delete_id"></form>
