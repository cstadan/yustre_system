...
<body class="shop-module">
    ...
    <nav class="sidebar" id="sidebar">
        ...
        <!-- Nav links -->
        <ul class="nav-menu">
            <li class="nav-item"><a href="dashboard_shop.php" class="nav-link active"><span class="nav-icon"><svg
            ...
            <li class="nav-item"><a href="../front/shop/modulesS/work_orders.php" class="nav-link"><span
            ...
            <li class="nav-item"><a href="../front/shop/modulesS/assets.php" class="nav-link"><span
                        class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                            height="18" fill="none">
            ...
            <li class="nav-item"><a href="../front/shop/modulesS/parts_inventory.php" class="nav-link"><span
                        class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                            height="18" fill="none">
                            <path
            ...
            <?php if ($_SESSION['user_rol'] === 'admin'): ?>
                <li class="nav-item bottom"><a href="dashboard_admin.php" class="nav-link"><span class="nav-icon"><svg
                                xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none">
                ...
                <li class="nav-item">
                    <a href="employees.php" class="nav-link"><span class="nav-icon"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 24 24" width="18" height="18" fill="none">
                                <circle cx="9" cy="7" r="4" stroke="currentColor" stroke-width="1.8" />
                                <path d="M2 21v-2a4 4 0 014-4h6a4 4 0 014 4v2" stroke="currentColor" stroke-width="1.8"
                                    stroke-linecap="round" />
                                <path d="M19 8v6M16 11h6" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" />
                            </svg></span><span class="nav-text">Employees</span></a>
                </li>
            <?php endif; ?>
    ...
    <div class="main-content" id="mainContent">
        ...
        <div class="welcome-section">
            ...
            <div class="user-badge"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="14" height="14"
                ...
                </svg><?php echo htmlspecialchars($_SESSION['user_email']); ?></div>
        </div>
        ...
        <div class="dashboard-grid-home">
            <div class="dashboard-card-large">
                <div class="card-header-custom">
                    <h3 class="card-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                            height="18" fill="none" style="vertical-align:middle;margin-right:8px">
                            <rect x="3" y="4" width="18" height="18" rx="2" stroke="#f5e6c8" stroke-width="1.8" />
                            <path d="M16 2v4M8 2v4M3 10h18" stroke="#f5e6c8" stroke-width="1.8"
                                stroke-linecap="round" />
                        </svg>Activity Calendar</h3>
                </div>
                <!-- Populated by calendar.js -->
                <div class="card-body-custom calendar-body" id="calendarBody">
                    <p class="placeholder-text">Loading calendar...</p>
                </div>
            </div>
                ...
                <div class="card-header-custom alerts-header">
                    <h3 class="card-title">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18" height="18" fill="none"
                            ...
                            <path d="M12 2a7 7 0 017 7c0 3.87-1.5 6-3 8H8c-1.5-2-3-4.13-3-8a7 7 0 017-7z"
                                stroke="#f5e6c8" stroke-width="1.8" />
                            <path d="M9 19a3 3 0 006 0" stroke="#f5e6c8" stroke-width="1.8" stroke-linecap="round" />
                        </svg>Alerts
                        <?php if (!empty($alerts)): ?><span
                                class="alerts-badge"><?php echo count($alerts); ?></span><?php endif; ?>
                    </h3>
                </div>
                <div class="card-body-custom alerts-body">
                    <?php if (empty($alerts)): ?>
                        <div class="alerts-empty">
                            <span class="alerts-empty-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                    width="48" height="48" fill="none">
                                    <path d="M5 13l4 4L19 7" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"
                                        stroke-linejoin="round" />
                                </svg></span>
        ...
        <div class="dashboard-card-large weather-card" style="margin-top:25px;min-height:auto;">
            <div class="card-header-custom"
                ...
                <h3 class="card-title"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="18"
                        height="18" fill="none" style="vertical-align:middle;margin-right:8px">
                        <path d="M18 10a6 6 0 00-12 0c0 3 2 5 2 5h8s2-2 2-5z" stroke="#f5e6c8" stroke-width="1.8" />
                        <path d="M12 2v2M4.22 4.22l1.42 1.42M20 12h2M2 12h2M19.78 4.22l-1.42 1.42" stroke="#f5e6c8"
                            stroke-width="1.8" stroke-linecap="round" />
                    </svg>Weather &mdash; <span id="weatherLocation">Loading...</span></h3>
            ...
            <div class="card-body-custom weather-body" id="weatherBody">
                <p class="placeholder-text">Loading weather data...</p>
            </div>
        </div>
    </div>
